...
HD_PWD='/home/aandreev/pro/v1.5_Deser/v1.5_Deser.runs/c_counter_binary_ch_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_counter_binary_ch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_counter_binary_ch.tcl
