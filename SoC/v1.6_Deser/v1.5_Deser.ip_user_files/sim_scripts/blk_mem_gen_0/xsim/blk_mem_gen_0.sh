...
#
# Generated by Vivado on Mon Aug 31 15:49:35 +07 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_1 -L work -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_0 work.blk_mem_gen_0 work.glbl -log elaborate.log
}
