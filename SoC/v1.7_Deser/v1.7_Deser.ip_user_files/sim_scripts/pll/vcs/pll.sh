...
#
# Generated by Vivado on Fri Sep 18 20:52:19 +07 2020
...
# Script info
echo -e "pll.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"/opt/cad/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"/opt/cad/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
  ...
  vlogan -work work $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"/opt/cad/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts work.pll work.glbl -o pll_simv
}
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/aandreev/pro/Stand-for-Calorimeter-Crystal/SoC/v1.6_Deser/v1.5_Deser.cache/compile_simlib/vcs"
  fi
