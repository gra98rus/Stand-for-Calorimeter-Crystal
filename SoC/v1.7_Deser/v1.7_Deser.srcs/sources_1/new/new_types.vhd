...
package new_types is 
    ...
    type adc_data_spectr_t  is array(0 to ADC_NB - 1)      of std_logic_vector(ADC_LENGTH - 1 downto ADC_LENGTH - clog2(BINS_NUM));
    type relevant_spectr_t  is array(0 to SPECTRA_NUM - 1) of std_logic_vector(ADC_LENGTH - 1 downto ADC_LENGTH - clog2(BINS_NUM));
