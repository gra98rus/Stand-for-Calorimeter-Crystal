...
-- Date        : Thu Oct 22 17:22:09 2020
-- Host        : aandreev-inp running 64-bit Ubuntu 18.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/aandreev/pro/Stand-for-Calorimeter-Crystal/SoC/v1.6_Deser/v1.5_Deser.srcs/sources_1/bd/ps_topp/ip/ps_topp_processing_system7_0_0/ps_topp_processing_system7_0_0_sim_netlist.vhdl
...
entity ps_topp_processing_system7_0_0_processing_system7_v5_5_processing_system7 is
  ...
  attribute POWER of ps_topp_processing_system7_0_0_processing_system7_v5_5_processing_system7 : entity is "<PROCESSOR name={system} numA9Cores={2} clockFreq={666.666666} load={0.5} /><MEMORY name={code} memType={DDR3} dataWidth={32} clockFreq={533.333333} readRate={0.5} writeRate={0.5} /><PLL domain={Processor} vco={1333.333} /><PLL domain={Memory} vco={1066.667} /><PLL domain={IO} vco={1600.000} /><AXI interface={M_AXI_GP0} dataWidth={32} clockFreq={50} usageRate={0.5} />/>";
